...
public class IncidentReportingSwingView extends JFrame implements IncidentReportingView {
	...
	private DefaultComboBoxModel<Tag> incidentTagComboBoxModel;
	private JComboBox<Tag> incidentTagComboBox;
	...
	private JPanel buildIncidentCreationPanel() {
		...
		// tags loaded from DB via setAvailableTags() before this panel is shown
		ic.gridx = 0; ic.gridy = 3; ic.weightx = 0;
		incidentSection.add(new JLabel("Tag"), ic);
		ic.gridx = 1; ic.weightx = 1.0;
		incidentTagComboBoxModel = new DefaultComboBoxModel<>();
		incidentTagComboBox = new JComboBox<>(incidentTagComboBoxModel);
		incidentTagComboBox.setName("incidentTagComboBox");
		incidentSection.add(incidentTagComboBox, ic);
		...
		submitIncidentButton.addActionListener(e -> {
			// TODO: call incidentController.reportIncident(...)
		});
		...
		backButton.addActionListener(e -> cardLayout.show(rootPanel, CARD_MAIN));
		...
		// spacer pushes the form to the top
		c.gridy = 1;
		c.weighty = 1.0;
